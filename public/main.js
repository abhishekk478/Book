...
module.exports = "\n<h1><p style=\"margin-top: 123px;\">About</p></h1><br>\n<h3>The repository where you find all your knowledge</h3>\n\n\n"
...
module.exports = "\n<img src=\"/assets/front.jpg\" width=\"100%\" height=\"100%\">\n<h1 class=\"para\">Book Hub</h1><br>\n\n<div class=\"container\">\n  <div class=\"well\" style=\"text-align: center; margin-top: 45px;\"><b>Books Detail</b></div>\n</div>\n\n<select  (change)=\"sortbyprice($event.target.value)\">\n    <option>Filter By Price</option>\n\n      <option [value]=1>Price Low to High</option>\n      <option [value]=2>Price High to Low</option>\n\n  </select>\n\n  <select name=\"bycondition\" (change)=\"sortFilter($event.target)\">\n    <option *ngFor=\"let cond of bookcondition\" [value]=\"cond\">{{cond}}</option>\n  </select>\n\n  <input type=\"search\" id=\"login-password\"  placeholder=\"Search By Book Name\" [(ngModel)]=\"Book\" (change)=\"onSearchChange($event.target.value)\" >\n<button style=\"background-color: white;\">Search</button>\n  <input type=\"search\" id=\"login-password\"  placeholder=\"Search By Author Name\"  (change)=\"onSearchAuthor($event.target.value)\" >\n<button style=\"background-color: white;\">Search</button>\n\n\n\n\n\n\n <div class=\"container\">\n\n         <div class=\"col-4 card mx-2 p-4\" style=\"float: left; margin-left: 40px;  width: 334px;margin-top: 19px; text-align: center;\" *ngFor=\"let do of pro\" >\n         <button (click)= \"listingsMenu(do.id)\" style=\"background-color: white;\"><div class=\"col-4 card mx-2 p-4\" style=\"float: left; margin-left: 40px;  width: 280px;margin-top: 23px; text-align: center;  \">\n            <img class=\"card-img-top\" [src]=\"'/myimage/'+do.id\" alt=\"Card image cap\" width=\"100%\" height=\"78%\"><hr>\n           <h4 class=\"product-name\">Book Name : {{do.BookName}}</h4>\n\n            <div class=\"product-book\">Author : {{do.AuthorName}}</div>\n            <div class=\"row\">\n                <div class=\"col m-3 p-3\" id=\"price\">\n                    <b>Price :  Rs.{{do.price}}</b>\n                    <br>\n                    <p>Condition : {{do.condition}}</p>\n\n\n                </div>\n\n\n            </div>  <!-- close row-->\n            </div> </button>\n        </div>` <!-- close for loop-->\n\n</div>  <!-- close continer-->\n"
...
module.exports = __webpack_require__(/*! F:\bootCamp\nagarro\project\src\main.ts */"./src/main.ts");
